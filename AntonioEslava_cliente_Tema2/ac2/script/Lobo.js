"use strict";  
// Activa el modo estricto de JavaScript, que ayuda a evitar errores comunes y promueve buenas prácticas.
...
function* aventuraInteractiva() {     
    // Primera narrativa y elección del jugador.
    ...
    // Rama de la primera decisión: el jugador cierra los ojos.
    if (eleccion1 === "A") {         
        ...
        // Rama basada en la segunda decisión: el jugador acusa a Elara.
        if (eleccion2 === "A") {             
        ...
        // Rama basada en la decisión de jugar agresivamente.
        if (eleccion2 === "B") {             
...
alert(aventura.next().value);  // Imprime el primer mensaje de la historia.

function siguienteTurno(eleccion) {     
    const resultado = aventura.next(eleccion); // Avanza en el generador con la elección del jugador.     
    if (resultado.done) {         
        alert("Fin de la historia: " + resultado.value); // Si se terminó, muestra el final.     
    } else {         
        alert(resultado.value); // Si no se terminó, muestra el siguiente mensaje.     
    } 
}  

// Proporciona elecciones al jugador y avanza en la historia.
siguienteTurno(prompt("Elige A o B")); // Respuesta a la primera elección. 
siguienteTurno(prompt("Elige A o B")); // Respuesta a la segunda elección, si corresponde. 
siguienteTurno(prompt("Elige A o B")); // Respuesta a la tercera elección, si corresponde. 
